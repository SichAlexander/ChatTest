 ...
 * on 2015-06-30 at 14:09:02 UTC 
 * Modify at your own risk.
 */

package com.example.alex.myapplication.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://simplechat-988.appspot.com/_ah/api/";
  ...
  public class ListDevices extends RegistrationRequest<com.example.alex.myapplication.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.example.alex.myapplication.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @param regId
   * @param phone
   * @param content the {@link com.example.alex.myapplication.backend.registration.model.UserInfo}
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String phone, com.example.alex.myapplication.backend.registration.model.UserInfo content) throws java.io.IOException {
    Register result = new Register(regId, phone, content);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{phone}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String phone, com.example.alex.myapplication.backend.registration.model.UserInfo content) {
