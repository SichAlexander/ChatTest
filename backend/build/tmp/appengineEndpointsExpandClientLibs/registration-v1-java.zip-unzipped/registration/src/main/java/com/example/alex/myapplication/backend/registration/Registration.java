...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String userName) throws java.io.IOException {
    Register result = new Register(regId, userName);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{userName}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String userName) {
